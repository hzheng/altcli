...
| --- | --- | --- | --- |
| Artifact | Ignored draft files and one unified plan | Handoff commits on one task branch, journal entries in CoderCrew | The shared index and worktree |
