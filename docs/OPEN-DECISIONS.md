...
| --- | --- |
| Project/worktree ownership | Explicit confirmed task-worktree creation is now in scope under ADR-0013, defaulting to ~/.altcli/<repo-name>/<branch-name>. Users still own environments and agent placement; automatic provisioning and cleanup remain excluded. |
